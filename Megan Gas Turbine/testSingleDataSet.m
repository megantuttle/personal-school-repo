%% last edited by Mike Moralle on 3/30 at 9 pm
...
% only a few more calculations to add... see sheet from Moodle WTF IS UP
% WITH MACH NUMBER

s_ideal = [s0 s0 s0 s4 s4 s4];
figure()
plot(S, T,'o',s_ideal, T0)
legend('2', '3', '4', '5', '6')
grid on
