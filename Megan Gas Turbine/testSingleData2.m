...
n_prop = (thrust*V_inlet) / ((mdot_air+mdot_fuel)*(H0(6) - H_exit) - (mdot_air*(H0(2) - H_inlet)));

% get the propulsive efficiency a different but theoretically equivalent way
n_prop1 = (thrust*V_inlet) / ((mdot_air+mdot_fuel)*(V_exit^2/2)/1000 - (mdot_air*(V_inlet^2/2)/1000));
