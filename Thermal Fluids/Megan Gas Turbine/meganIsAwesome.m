function [RPM, n_cycle, PM, n_prop, n_comp, n_comb, n_turb, n_nozz, thrust,...
    Ts, TSFC, ThThrust, ThTs, ThTSFC, uTs, uTSFC, uNcyc, uPM, uNprop, uComb,...
    uNozz, u_RPM ] = meganIsAwesome(filename, data)
...
u_P1 = 0.0014*P(2)/1000;    % percent FS, convert to kPa
u_P2 = 0.0025*P(3)/1000;   
u_P3 = 0.0025*P(4)/1000;    
u_P4 = 0.0025*P(5)/1000;    
u_P5 = 0.0025*P(6)/1000;    
...
%% Nozzle efficiency uncertainty
uNozz = sqrt( u_P4^2 + u_P5^2 + u_T(4)^2 + u_T(5)^2 );
